...
public class ByteArrayOutputStream extends OutputStream {
   ...
   *
   * @throws IOException
   *           never (this method should not declare this exception but it has to
  ...
  /**
   * Gets the current contents of this byte stream as a byte array. The result is
  ...
  /**
   * Gets the current contents of this byte stream as a string using the platform
   * default charset.
   * 
  ...
  /**
   * Gets the current contents of this byte stream as a string using the specified
   * encoding.
   *
   * @param enc
