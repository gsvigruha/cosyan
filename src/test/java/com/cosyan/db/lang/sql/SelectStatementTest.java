...
public class SelectStatementTest extends UnitTestBase {
  ...
  public void testReverseForeignKeys() {
    ...
    execute("alter table t10 add aggref s (select sum(b2) as sb, count(b2) as cb from rev_fk_a);");
  ...
  public void testReverseForeignKeyDependentTable() {
    ...
    execute("alter table t12 add aggref s (select sum(fk_w.b4) as sb from rev_fk_v);");
  ...
  public void testReverseForeignKeyWithWhere() {
    ...
    execute("alter table t15 add aggref s (select sum(b2) as sb from rev_fk_a where c2 >= 2);");
  ...
  public void testNullableReverseForeignKey() {
    ...
    execute("alter table t19 add aggref s (select sum(b2) as sb from rev_fk_a);");
